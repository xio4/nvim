...
let g:used_javascript_libs = 'ramda,underscore,requirejs,chai,jasmine,jquery'
...
hi! Normal ctermbg=NONE guibg=#102025
...
nmap <leader>tt :DeniteProjectDir file/rec<CR>
...
autocmd FileType javascriptreact nnoremap <Leader>ra :<c-u>call ReplacePathToAbs()<cr> 
autocmd FileType typescript nnoremap <Leader>ra :<c-u>call ReplacePathToAbs()<cr>
autocmd FileType typescriptreact nnoremap <Leader>ra :<c-u>call ReplacePathToAbs()<cr> 
